...
const toAsync = fn => (...args) =>
    new Promise((resolve, reject) =>
        fn(...args, (err, data) =>
            !err ? resolve(data) : reject(err.message)))
...
const readWithToAsync = async () => {
    try {
        const result = (await toAsync(fs.readFile)('./modules/index.js')).toString()
...
fs.promises.readFile('./modules/index.js')
    .then(res => console.log('> ', res.toString()))
    .catch(err => console.error('> err: ', err.message))

const readWithFsPromises = async () => {
    try {
        const result = (await fs.promises.readFile('./modules/index.js')).toString()
        console.log('> result: ', result)
    } catch(error) {
        console.error('> error: ', error.message)
    }
